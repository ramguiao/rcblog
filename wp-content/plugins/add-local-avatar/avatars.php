...
define('AVATAR_VER', '10.6');															// Plug-in version.
...
//		add_action('edit_user_profile', array(&$this, 'avatar_uploader_option'));
		...
		add_filter('plugin_row_meta', array(&$this, 'avatar_links'), 10, 2);
		add_action('plugin_action_links_' . plugin_basename(__FILE__), array(&$this, 'avatar_shortcuts'), 10, 2);
	} // end constructor
	...
	function manage_avatar_cache()
	{
		...
		<div class="wrap">
			<span id='icon-users' class='icon32'></span><h2><?php echo __('Avatar Settings', 'avatars'); ?> (v<?php echo AVATAR_VER; ?>)</h2>
			<p>
